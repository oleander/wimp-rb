...
module WiMP
  ...
  class Track
    ...
    FIELDS = {
      ...
      RECORDLABEL => {:type => ::Thrift::Types::STRUCT, :name => 'recordLabel', :class => ::WiMP::RecordLabel},
    ...
    def validate
      ...
      raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field trackId is unset!') unless @trackId
  ...
  class Playlist
    ...
    FIELDS = {
      ...
      TRACKS => {:type => ::Thrift::Types::LIST, :name => 'tracks', :element => {:type => ::Thrift::Types::STRUCT, :class => ::WiMP::Track}, :optional => true},
  ...
  class SearchResult
    ...
    FIELDS = {
      ARTISTS => {:type => ::Thrift::Types::LIST, :name => 'artists', :element => {:type => ::Thrift::Types::STRUCT, :class => ::WiMP::Artist}},
      TRACKS => {:type => ::Thrift::Types::LIST, :name => 'tracks', :element => {:type => ::Thrift::Types::STRUCT, :class => ::WiMP::Track}},
      ALBUMS => {:type => ::Thrift::Types::LIST, :name => 'albums', :element => {:type => ::Thrift::Types::STRUCT, :class => ::WiMP::Album}},
      PLAYLIST => {:type => ::Thrift::Types::LIST, :name => 'playlist', :element => {:type => ::Thrift::Types::STRUCT, :class => ::WiMP::Playlist}}
    }

    def struct_fields; FIELDS; end

    def validate
      raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field artists is unset!') unless @artists
      raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field tracks is unset!') unless @tracks
  ...
  class SimilarAlbumList
    ...
    FIELDS = {
      SIMILARALBUMS => {:type => ::Thrift::Types::LIST, :name => 'similarAlbums', :element => {:type => ::Thrift::Types::STRUCT, :class => ::WiMP::SimilarAlbum}},
      SOURCENAME => {:type => ::Thrift::Types::STRING, :name => 'sourceName'}
    }
  ...
  class AlbumMetadata
    ...
    FIELDS = {
      ...
      TITLE => {:type => ::Thrift::Types::STRING, :name => 'title'},
      ARTISTID => {:type => ::Thrift::Types::I32, :name => 'artistId'},
      ALBUMREVIEW => {:type => ::Thrift::Types::STRUCT, :name => 'albumReview', :class => ::WiMP::AlbumReview},
      SIMILARALBUMLIST => {:type => ::Thrift::Types::STRUCT, :name => 'similarAlbumList', :class => ::WiMP::SimilarAlbumList}
    }
  ...
  class SimilarArtistList
    ...
    FIELDS = {
      SIMILARARTISTLIST => {:type => ::Thrift::Types::LIST, :name => 'similarArtistList', :element => {:type => ::Thrift::Types::STRUCT, :class => ::WiMP::SimilarArtist}},
      SOURCENAME => {:type => ::Thrift::Types::STRING, :name => 'sourceName'}
    }
  ...
  class RelatedArtistList
    ...
    FIELDS = {
      RELATEDARTISTLIST => {:type => ::Thrift::Types::LIST, :name => 'relatedArtistList', :element => {:type => ::Thrift::Types::STRUCT, :class => ::WiMP::RelatedArtist}},
      SOURCENAME => {:type => ::Thrift::Types::STRING, :name => 'sourceName'}
    }
  ...
  class ArtistLinkList
    ...
    FIELDS = {
      ARTISTLINKS => {:type => ::Thrift::Types::LIST, :name => 'artistLinks', :element => {:type => ::Thrift::Types::STRUCT, :class => ::WiMP::ArtistLink}},
      SOURCENAME => {:type => ::Thrift::Types::STRING, :name => 'sourceName'}
    }
  ...
  class ArtistMetaData
    ...
    FIELDS = {
      ARTISTID => {:type => ::Thrift::Types::I32, :name => 'artistId'},
      ARTISTNAME => {:type => ::Thrift::Types::STRING, :name => 'artistName'},
      ARTISTBIOGRAPHY => {:type => ::Thrift::Types::STRUCT, :name => 'artistBiography', :class => ::WiMP::ArtistBiography},
      SIMILARARTISTS => {:type => ::Thrift::Types::STRUCT, :name => 'similarArtists', :class => ::WiMP::SimilarArtistList},
      RELATEDARTISTS => {:type => ::Thrift::Types::STRUCT, :name => 'relatedArtists', :class => ::WiMP::RelatedArtistList},
      ARTISTLINKS => {:type => ::Thrift::Types::STRUCT, :name => 'artistLinks', :class => ::WiMP::ArtistLinkList}
    }
  ...
  class CategoryTree
    ...
    FIELDS = {
      CATEGORY => {:type => ::Thrift::Types::STRUCT, :name => 'category', :class => ::WiMP::Category, :optional => true},
      CHILDREN => {:type => ::Thrift::Types::MAP, :name => 'children', :key => {:type => ::Thrift::Types::I32}, :value => {:type => ::Thrift::Types::LIST, :element => {:type => ::Thrift::Types::STRUCT, :class => ::WiMP::Category}}, :optional => true}
    }
  ...
  class FavoriteAlbum
    ...
    FIELDS = {
      ...
      ALBUM => {:type => ::Thrift::Types::STRUCT, :name => 'album', :class => ::WiMP::Album},
      PROFILEID => {:type => ::Thrift::Types::I32, :name => 'profileId'}
    }
  ...
  class FavoriteArtist
    ...
    FIELDS = {
      ...
      ARTIST => {:type => ::Thrift::Types::STRUCT, :name => 'artist', :class => ::WiMP::Artist},
      ALBUMS => {:type => ::Thrift::Types::LIST, :name => 'albums', :element => {:type => ::Thrift::Types::STRUCT, :class => ::WiMP::Album}},
      PROFILEID => {:type => ::Thrift::Types::I32, :name => 'profileId'}
    }
  ...
  class FavoritePlaylist
    ...
    FIELDS = {
      DATEADDED => {:type => ::Thrift::Types::I64, :name => 'dateAdded'},
      PLAYLIST => {:type => ::Thrift::Types::STRUCT, :name => 'playlist', :class => ::WiMP::Playlist},
      PROFILEID => {:type => ::Thrift::Types::I32, :name => 'profileId'}
    }
  ...
  class FavoriteTrack
    ...
    FIELDS = {
      DATEADDED => {:type => ::Thrift::Types::I64, :name => 'dateAdded'},
      TRACK => {:type => ::Thrift::Types::STRUCT, :name => 'track', :class => ::WiMP::Track},
      PROFILEID => {:type => ::Thrift::Types::I32, :name => 'profileId'}
    }
